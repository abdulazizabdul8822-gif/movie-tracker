...
import user from '../../assets2/1.png'
import packageImg from '../../assets2/Black And Red Minimalist Movie Instagram Post.png'
import rocket from '../../assets2/Black Grey Minimalist Modern Cinema Logo.png'
const Steps = () => {
    return (
        <div>
            <div className=' py-20 px-4 md:px-0 '>
                <div className=' flex flex-col justify-center items-center space-y-3 py-10 text-center'>
                    ...
                    <p className=' text-white'>Search & filter movies you like</p>
                </div>
                <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 container mx-auto '>
                    <div className=' bg-white shadow-lg transition-transform duration-300 hover:scale-102 relative  flex flex-col items-center justify-between p-10 space-y-5 rounded-md '>
                        ...
                        <p className=' text-white'>
                            Search & filter movies you like</p>
                    </div>
                    <div className=' bg-white shadow-lg transition-transform duration-300 hover:scale-102 relative flex flex-col items-center justify-between p-10 rounded-md'>
                        ...
                        <img className=' w-100 ' src={packageImg} alt="" />
                        <h2 className=' font-semibold text-xl'>❤️ Watchlist</h2>
                        <p className=' '>Save movies to watch later .</p>
                    </div>
                    <div className=' relative bg-white shadow-lg flex flex-col items-center justify-between p-10 rounded-md transition-transform duration-300 hover:scale-102'>
                        ...
                        <p className=' text-white'>Mark as watched when done</p>
                    </div>
                </div>
            </div>
        </div>
