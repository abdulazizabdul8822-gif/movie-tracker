        ...
        <div>
            <div className=' py-20 px-4 md:px-0 '>
                ...
                <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 container mx-auto '>
                    <div className=' bg-zinc-500 transition-transform duration-300 hover:scale-102 relative  flex flex-col items-center justify-between p-10 space-y-5 rounded-md '>
                    ...
                    <div className=' bg-zinc-500 transition-transform duration-300 hover:scale-102 relative flex flex-col items-center justify-between p-10 rounded-md'>
                    ...
                    <div className=' relative bg-zinc-500 flex flex-col items-center justify-between p-10 rounded-md transition-transform duration-300 hover:scale-102'>
                        ...
                        <p className=' '>movies you like when done</p>
                    </div>
                </div>
            </div>
        </div>
